class VideoResponseUploadJob < ApplicationJob
  ...
  def perform(response)
    ...
    create_asset_request.input = Aws::S3::Presigner.new(client: S3).presigned_url(:get_object, bucket: 'clientviews-temp-videos', key: response.video_feedback_data.blob.key)
