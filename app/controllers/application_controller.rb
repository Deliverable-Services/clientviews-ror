class ApplicationController < ActionController::Base
 ...
 impersonates :user
  ...
  def set_yoha_cookies
    cookies[:yoha_visit] ||= {value: SecureRandom.uuid, expires: 4.hours.from_now, domain: Rails.env.production? ? 'app.clientviews.com' : 'localhost', secure: true}
    cookies[:yoha_visitor] ||= {value: SecureRandom.uuid, expires: 2.years.from_now, domain: Rails.env.production? ? 'app.clientviews.com' : 'localhost', secure: true}
